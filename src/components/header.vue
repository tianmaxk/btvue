...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<a href="javascript:;" class="menu-toggler responsive-toggler" :class="{collapsed:showMenu}" data-toggle="collapse" data-target=".navbar-collapse" @click="onShowMenu">
		</a>
...
export default {
  ...
  methods:{
	  onShowMenu(){
		  if(!this.showMenuInPhone || !this.showMenu){
			  this.showMenu = true;
		  } else {
			  this.showMenu = false;
		  }
		  this.$store.commit(this.showMenu?'onShowMenuInPhone':'onHideMenuInPhone');
	  }
  },
  computed: {
    ...mapState({
